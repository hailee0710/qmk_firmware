...
#define LAYOUT_5x6_right_base( \
  ...
  LAYOUT_5x6_right_wrapper( \
     ...
     KC_1, KC_2,                  OS_LALT, OS_LGUI,                                                OS_RGUI, OS_RALT,KC_3, KC_4 \
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAMEPAD] = LAYOUT_5x6_right(
        ...
        KC_1, KC_2,                  KC_I,    KC_T,                                                               TG_GAME, KC_NO, KC_3, KC_4,
                                            KC_V,    KC_O,                                    _______,
                                                     KC_SPC,  KC_P,                  _______,
    ...
    [_DIABLO] = LAYOUT_5x6_right(
        ...
        KC_1, KC_2,                  KC_F,    KC_L,                                                               KC_NO,   TG_DBLO,_______, _______,
    ...
    [_DIABLOII] = LAYOUT_5x6_right(
        ...
        KC_LCTL, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,                         _______, _______, _______, _______, _______, _______,
         KC_1, KC_2,                 KC_F,    KC_L,                                                               KC_NO,   TG(_DIABLOII),_______, _______,
    ...
    [_ADJUST] = LAYOUT_5x6_right_wrapper(
        ...
        _______, _______,           TG(_DIABLOII), AUTO_CTN,                                                            TG_GAME, TG_DBLO,_______, _______,
